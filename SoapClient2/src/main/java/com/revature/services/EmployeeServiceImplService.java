 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://services.revature.com/", wsdlLocation = "http://localhost:8080/SoapService/employees?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://services.revature.com/", "EmployeeServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapService/employees?wsdl");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://services.revature.com/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.revature.com/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }
