...
public class Shorts extends Bottoms {
	...
	public Shorts() {
		this.setCategory("shorts");
		System.out.println("You created a new pair of shorts, here are the details:");
		System.out.println(this.toString());
	}
	
	// here is an example of overloading - a polymorphism concept
	public Shorts(String brand, String color, String material) {
		this.setBrand(brand);
		this.setColor(color);
	...
	public void putOn() {
		if (!status) {
			System.out.println("You put on shorts... I don't think you can wear those at work...");
			wearStatus(true);
		} else {
	...
	public void takeOff() {
		if (status) {
			System.out.println("You take off your shorts");
			wearStatus(false);
		} else {
			System.out.println("You are not wearing these shorts!");
		}
	}
}