...
function viewPending(){
	sendAjaxGet("http://localhost:8080/Reimbursement/reimbursement", displayAllPending);
}

function viewResolved(){
	sendAjaxGet("http://localhost:8080/Reimbursement/reimbursement", displayAllResolved);
}

function viewEmployees(){
	sendAjaxGet("http://localhost:8080/Reimbursement/profile", displayProfiles);
}

function searchEmployee(){
	let id = document.getElementById("empId").value;
	sendAjaxGet("http://localhost:8080/Reimbursement/reimbursement?id=" + id, displayAllReimbursements);
}
